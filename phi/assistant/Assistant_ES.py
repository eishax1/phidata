from event_source.Decorator import record_state, event_store
from event_source.Decorator import event_store
from event_source.AgentState import AgentStateEnum
...
class Assistant(BaseModel):
    ...
    def get_user_prompt(
        ...
        return _user_prompt
    @record_state((AgentStateEnum.RECEIVED, AgentStateEnum.RESPONDED, event_store, AgentStateEnum.RECEIVED))
    def _run(
        self,
        message: Optional[Union[List, Dict, str]] = None,
        *,
...
# Example usage
assistant = Assistant(run_id="12345")  # Instantiating the Assistant with a run_id
user_message = "What is the weather today?"  # a test user message

# Call the _run method to simulate the LLM response
response = list(assistant._run(message=user_message, stream=False)) 
print(response)